    ...
    <section className="flex flex-col items-center justify-center gap-[60px] w-full h-auto">
      <div className="flex flex-col gap-[60px] max-w-[1280px] w-full  md:flex-row items-center justify-between">
        ...
        <div className="flex flex-col gap-3  items-start md:max-w-[652px] w-full h-auto justify-center">
          ...
          >
            Our entrance door designs are crafted with a focus on innovation, durability, and customer-centric solutions, ensuring excellence and elegance in every detail.
          </motion.h3>
