...
import { foldingSeriesData } from "../constants/ProductsData";
...
const FoldProductsCard = () => {
  const [selectedSeries, setSelectedSeries] = useState("WE 70");

  const currentSeries = foldingSeriesData.find(
...
export default FoldProductsCard;
