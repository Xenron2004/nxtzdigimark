...
import AluminiumDoor from "../assets/intertwo.webp";

const featuresAndUsesData = [
  {
    imageSrc: AluminiumDoor,
    FeatureHeading: "Modern Features of Slide & Fold Doors",
    FeatureDesc:
      "Blending sliding and folding mechanisms, our slide & fold doors feature robust frames, smooth operation, and versatile designs. With weather-resistant coatings and minimalist aesthetics, they offer durability and contemporary appeal.",
    UseHeading: "Dynamic Uses for Versatile Spaces",
    UseDesc:
      "Perfect for large office spaces and open-plan living areas, these doors enhance connectivity and functionality. Ideal for modern homes, they create multipurpose spaces while maintaining a sleek and stylish appearance.",
  },
