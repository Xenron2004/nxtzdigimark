...
import AbtImage from "../assets/6424.jpg"
      ...
      <div className="flex flex-col gap-[60px] max-w-[1280px] w-full  md:flex-row items-center justify-between">
        ...
        <div className="flex flex-col gap-3  items-start md:max-w-[652px] w-full h-auto justify-center">
          ...
          <div className="flex flex-col gap-3">
            ...
            >
              Tostem Aluminium Windows Designs
            </motion.h1>
          </div>
          ...
          {/* CTA Button */}
          <Link href="/contact">
          <button className="font-montserrat  bg-primary text-white text-[16px] tracking-[2%] px-5 py-3">
            CONTACT
          </button>
          </Link>
        </div>
