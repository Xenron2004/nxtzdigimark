...
import { frenchSeriesData } from "../constants/ProductsData";
...
const FrWindowProductCard = () => {
  const [selectedSeries, setSelectedSeries] = useState("WE 70");

  const currentSeries = frenchSeriesData.find(
...
export default FrWindowProductCard;
