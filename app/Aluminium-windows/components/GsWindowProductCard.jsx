...
import { glassSeriesData } from "../constants/ProductsData";
...
const GsWindowProductCard = () => {
  const [selectedSeries, setSelectedSeries] = useState("Grants");

  const currentSeries = glassSeriesData.find(
...
export default GsWindowProductCard;
