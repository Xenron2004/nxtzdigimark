...
import Security from "../../products/assets/security.webp";
import Rubber from "../../products/assets/rubber.webp";
import Glass from "../../products/assets/wideglass.webp";
    ...
    <section className="flex flex-col items-center justify-center gap-[60px] w-full h-auto">
      <div className="flex flex-col gap-[60px] max-w-[1280px] w-full  md:flex-row items-center justify-between">
        ...
        <div className="flex flex-col gap-5  items-start md:max-w-[652px] w-full h-auto justify-center">
          ...
          >
            Our facade designs are crafted with a focus on innovation, sustainability, and architectural excellence, ensuring durability and elegance in every detail.
          </motion.h3>
